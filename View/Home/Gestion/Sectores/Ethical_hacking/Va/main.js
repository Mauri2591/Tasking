$(document).ready(function () {
    tabla = $("#table_proyectos_nuevos_eh_vas").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
    ...
    tabla = $("#table_proyectos_abiertos_eh_vas").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
    ...
    tabla = $("#table_proyectos_realizados_eh_vas").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
    ...
    tabla = $("#table_proyectos_cerrado_calidad_eh_vas").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            setTimeout(() => {
                ...
                if ($.fn.DataTable.isDataTable('#table_proyectos_abiertos_eh_vas')) {
                    $('#table_proyectos_abiertos_eh_vas').DataTable().ajax.reload(null, false);
                }
...
function cambiar_a_realizado(id_proyecto_cantidad_servicios) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $('#table_proyectos_abiertos_eh_vas').DataTable().ajax.reload(null, false);
            $('#table_proyectos_realizados_eh_vas').DataTable().ajax.reload(null, false);
        }
    })
}