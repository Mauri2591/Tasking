                ...
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0"><span class="badge bg-warning text-dark border border-dark">ETHICAL
                                HACKING</span><span class="badge bg-dark text-light border mx-1 border-dark">MOBILE</span>
                        </h4>
                    </div>
                </div>
            </div>
                        ...
                        <div class="tab-content text-muted">
                            <div class="tab-pane active" id="tab_nuevos" role="tabpanel">
                                <div class="card card-body">
                                    <table id="table_proyectos_nuevos_eh_mobile" style="text-align: center; width: 100%;">
                            ...
                            <div class="tab-pane" id="tab_abiertos" role="tabpanel">
                                <div class="card card-body">
                                    <table id="table_proyectos_abiertos_eh_mobile" style="text-align: center; width: 100%;">
                                        <thead style="text-align: center;">
                                            <tr style="text-align: center;">
                                                <th style="width: 300px;text-align: center;">TITULO</th>
                                                <th style="width: 300px;text-align: center;">INICIO</th>
                            ...
                            <div class="tab-pane" id="tab_realizados" role="tabpanel">
                                <div class="card card-body">
                                    <table id="table_proyectos_realizados_eh_mobile"
                            ...
                            <div class="tab-pane" id="tab_cerrados_calidad" role="tabpanel">
                                <div class="card card-body">
                                    <table id="table_proyectos_cerrado_calidad_eh_mobile"
                                        style="text-align: center; width: 100%;">
                                        <thead style="text-align: center;">
                                            <tr style="text-align: center;">
                                                <th style="width: 300px;text-align: center;">TITULO</th>
