$(document).ready(function () {
    tabla = $("#table_proyectos_nuevos_eh_sast").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
    ...
    tabla = $("#table_proyectos_abiertos_eh_sast").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
    ...
    tabla = $("#table_proyectos_realizados_eh_sast").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
    ...
    tabla = $("#table_proyectos_cerrado_calidad_eh_sast").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
...
function cambiar_a_borrador(id_proyecto_cantidad_servicios) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            setTimeout(() => {
                if ($.fn.DataTable.isDataTable('#table_proyectos_nuevos_eh_sast')) {
                    $('#table_proyectos_nuevos_eh_sast').DataTable().ajax.reload(null, false);
...
function cambiar_a_abierto(id_proyecto_cantidad_servicios) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            setTimeout(() => {
                if ($.fn.DataTable.isDataTable('#table_proyectos_abiertos_eh_sast')) {
                    $('#table_proyectos_abiertos_eh_sast').DataTable().ajax.reload(null, false);
                    $('#table_proyectos_nuevos_eh_sast').DataTable().ajax.reload(null, false);
                }
            }, 500);
        }
...
function cambiar_a_realizado(id_proyecto_cantidad_servicios) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $('#table_proyectos_abiertos_eh_sast').DataTable().ajax.reload(null, false);
            $('#table_proyectos_realizados_eh_sast').DataTable().ajax.reload(null, false);
        }
    })
}