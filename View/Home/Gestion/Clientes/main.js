$(document).ready(function () {
    ...
    $.post("../../../../Controller/ctrProyectos.php?proy=get_combo_prioridad_proy_nuevo_eh",
        function (data, textStatus, jqXHR) {
            ...
            document.getElementById("combo_prioridad_proy_nuevo").addEventListener("change", function () {
                switch (this.value) {
                    case "1":
                    ...
                    case "2":
                        $("#combo_prioridad_proy_nuevo").removeClass("border-danger");
                        $("#combo_prioridad_proy_nuevo").addClass("border-warning");
                        $("#combo_prioridad_proy_nuevo").removeClass("border-bg");
                        break;

                    case "3":
                        $("#combo_prioridad_proy_nuevo").addClass("border-danger");
                        $("#combo_prioridad_proy_nuevo").removeClass("border-warning");
                        $("#combo_prioridad_proy_nuevo").removeClass("border-bg");
                        break;
