                    ...
                    <form id="form_alta_proyecto" enctype="multipart/form-data">
                        ...
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="mb-3 col-sm-3">
                                    <span class="badge bg-light fs-10 mb-1 text-dark">Sub Categoria</span>
                            ...
                            <div id="cont_activos">
                                <span class="mt-4 badge bg-light border border-primary text-primary"
                                    ...
                                    data-placement="top" title="Consultar activos" type="button"><i
                                        class="ri-questionnaire-fill text-warning fs-20"></i>
                                </span>
                            </div>
                        ...
                        <div id="cont_btn_Modal_Ajustar_proy" class="text-end mt-3">
                            ...
                            <button id="btn_eliminar_proyecto" type="submit"
                                class="btn btn-sm btn-danger">Eliminar</button>
                            <button id="btn_cancelar_proyecto" type="submit"
                                class="btn btn-sm btn-warning text-dark">Cancelar</button>
                            ...
                            <button id="btn_editar_proyecto" type="submit" class="btn btn-sm btn-success">Guardar
                                Edicion</button>
